...
const ServiceModal: React.FC<ServiceModalProps> = ({ service, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className={`relative bg-white w-full ${view === 'details' ? 'max-w-2xl' : 'max-w-5xl'} max-h-[95vh] overflow-y-auto rounded-[2rem] border border-[#D4AF37]/30 shadow-[0_20px_50px_rgba(212,175,55,0.15)] transition-all duration-500 animate-in fade-in zoom-in`}>
                {/* Close Button */}
                <button
                    onClick={onClose}
                    className="absolute top-8 right-8 z-20 text-[#1A1A1A] hover:text-[#D4AF37] transition-colors"
                >
                ...
                {view === 'details' ? (
                    ...
                    <div className="p-8 sm:p-14 md:p-20 flex flex-col items-center text-center">
                        <div className="w-24 h-24 bg-[#FFF8E7] rounded-3xl mb-10 shadow-sm border border-[#D4AF37]/20 flex items-center justify-center">
                            <img
                                src="/images/logo.png"
                                alt="Eagle Eye"
                        ...
                        <h2 className="text-4xl md:text-5xl font-black text-[#1A1A1A] mb-8 tracking-tight uppercase">
                            {service.title}
                        </h2>
                        ...
                        <div className="space-y-8 max-w-lg">
                            ...
                            <p className="text-[#777777] text-base leading-relaxed italic">
                        ...
                        <div className="mt-14 w-full">
                            <button
                                ...
                                className="btn-gold w-full py-6 rounded-2xl shadow-lg"
                            >
                    ...
                    <div className="flex flex-col md:flex-row min-h-[600px]">
                        <div className="md:w-5/12 p-10 md:p-16 bg-[#FFF8E7] border-r border-[#D4AF37]/20 flex flex-col justify-center">
                            <button
                            ...
                            <h3 className="text-3xl md:text-4xl font-black text-[#1A1A1A] mb-6 uppercase tracking-tight">Request a <span className="text-[#D4AF37]">Quote</span></h3>
                            ...
                            <div className="mt-10 space-y-4">
                                <div className="flex items-center gap-4 text-[#D4AF37]">
                                    ...
                                    <span className="text-[#1A1A1A] font-bold">Priority Response</span>
                                </div>
                                <div className="flex items-center gap-4 text-[#D4AF37]">
                                    <i className="fas fa-check-circle"></i>
                                    <span className="text-[#1A1A1A] font-bold">Vetted Professionals</span>
                                </div>
                            </div>
                        </div>
                        <div className="md:w-7/12 p-8 sm:p-14 bg-white">
